...
//  UnityFramework
//
//  Created by Alexey Goncharov on 19.10.23..
//

import Adapty
import Foundation

public enum AdaptyUIUnityError: Error {
    case viewNotFound(String)
    case viewAlreadyPresented(String)
    case viewPresentationError(String)
}

extension AdaptyUIUnityError: CustomDebugStringConvertible {
...
extension AdaptyUIUnityError: CustomAdaptyError {
